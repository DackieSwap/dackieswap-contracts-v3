...
import "./DackiePadInitializableV6.sol";

/**
 * @title DackiePadDeployer
 */
contract DackiePadDeployerV6 is Ownable {
    ...
    function createIDO(
        ...
        bytes memory bytecode = type(DackiePadInitializableV6).creationCode;
        ...
        DackiePadInitializableV6(idoAddress).initialize(
            _raiseToken,
            _offeringToken,
            _startBlock,
            _endBlock,
