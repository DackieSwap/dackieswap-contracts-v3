...
/// @notice An example contract using the DackieSwap V3 flash function
contract PairFlash is IDackieV3FlashCallback, PeripheryPayments {
    ...
    /// @notice Calls the pools flash function with data needed in `DackieV3FlashCallback`
