...
contract MixedRouteQuoterV1 is IMixedRouteQuoterV1, IDackieV3SwapCallback, PeripheryImmutableState {
    ...
    */
    ...
    function pancakeV3SwapCallback(
        ...
        IDackieV3Pool pool = SmartRouterHelper.getPool(deployer, tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IDackieV3Pool pool = SmartRouterHelper.getPool(deployer, params.tokenIn, params.tokenOut, params.fee);
