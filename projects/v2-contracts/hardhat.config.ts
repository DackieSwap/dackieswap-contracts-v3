...
const LEGACY1_COMPILER_SETTINGS = {
  version: '0.6.6',
  settings: {
    evmVersion: 'istanbul',
    optimizer: {
...
const LEGACY2_COMPILER_SETTINGS = {
  version: '0.5.16',
  settings: {
    evmVersion: 'istanbul',
    optimizer: {
...
const LEGACY3_COMPILER_SETTINGS = {
  version: '0.4.18',
  settings: {
    evmVersion: 'istanbul',
    optimizer: {
...
const worldChain: NetworkUserConfig = {
  url: "https://worldchain-mainnet.g.alchemy.com/public",
  chainId: 480,
  accounts: [process.env.KEY_MAINNET!],
};

const unichainSepolia: NetworkUserConfig = {
...
const config = {
  ...
  solidity: {
    compilers: [
      ...
      LEGACY1_COMPILER_SETTINGS,
      LEGACY2_COMPILER_SETTINGS,
      LEGACY3_COMPILER_SETTINGS
    ],
  },
  paths: {
    sources: './contracts',
