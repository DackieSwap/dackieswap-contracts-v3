...
contract MasterChefV3 is INonfungiblePositionManagerStruct, Multicall, Ownable, ReentrancyGuard, Enumerable {
    ...
    event AddPool(uint256 indexed pid, uint256 allocPoint, IDackieV3Pool indexed v3Pool, ILMPool indexed lmPool);
    ...
    function add(uint256 _allocPoint, IDackieV3Pool _v3Pool, bool _withUpdate) external onlyOwner {
