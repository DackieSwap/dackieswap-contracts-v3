...
contract QuoterV2 is IQuoterV2, IDackieV3SwapCallback, PeripheryImmutableState {
    using Path for bytes;
    using SafeCast for uint256;
    using PoolTicksCounter for IDackieV3Pool;
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IDackieV3Pool) {
        return IDackieV3Pool(PoolAddress.computeAddress(deployer, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }
    ...
    function pancakeV3SwapCallback(
        ...
        IDackieV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IDackieV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
