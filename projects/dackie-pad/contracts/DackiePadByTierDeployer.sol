...
import "./DackiePadByTier.sol";

/**
 * @title DackiePadByTierDeployer
 */
contract DackiePadByTierDeployer is Ownable {
    ...
    function createIDO(
        ...
        bytes memory bytecode = type(DackiePadByTier).creationCode;
        ...
        DackiePadByTier(idoAddress).initialize(
            _raiseToken,
            _offeringToken,
            _startBlock,
            _endBlock,
